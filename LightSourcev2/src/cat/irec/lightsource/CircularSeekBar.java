...
public class CircularSeekBar extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText(String.valueOf( (Math.round((float)mMax * mProgressDegrees / mTotalCircleDegrees))), -50, 0, paint); 
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mCircleHeight = (float)CENTER_Y - mCircleStrokeWidth - mPointerRadius - (mPointerHaloBorderWidth * 1.5f);
		mCircleWidth = (float)CENTER_X - mCircleStrokeWidth - mPointerRadius - (mPointerHaloBorderWidth * 1.5f);
