...
import cat.irec.lightsource.RGBControl.OnColorChangedListener;
...
public class ColorPickerView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(10, 316, /*138*/ 266, 356, mPaint);
		...
		if (Color.red(mCurrentColor)+Color.green(mCurrentColor)+Color.blue(mCurrentColor) < 384)
			...
			mPaint.setColor(Color.BLACK);
		canvas.drawText(getResources().getString(R.string.confirm), /*74*/133, 340, mPaint);
/*
			...
			if (Color.red(mDefaultColor)+Color.green(mDefaultColor)+Color.blue(mDefaultColor) < 384)
				...
				mPaint.setColor(Color.BLACK);
			canvas.drawText(getResources().getString(R.string.defecto), 202, 340, mPaint);*/
	}
